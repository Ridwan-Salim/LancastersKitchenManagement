...
public class MockData {
    ...
    public static void addWines() {
        wines.put(1, new String[]{"Chardonnay", "15.0", "A crisp white wine with notes of citrus and oak.", "2019", "20"});
        wines.put(2, new String[]{"Merlot", "12.0", "A smooth red wine with flavors of plum and cherry.", "2018", "25"});
        wines.put(3, new String[]{"Cabernet Sauvignon", "18.0", "A bold red wine with rich dark fruit flavors and firm tannins.", "2017", "15"});
        wines.put(4, new String[]{"Pinot Noir", "20.0", "A delicate red wine with aromas of red berries and earthy undertones.", "2016", "30"});
        wines.put(5, new String[]{"Sauvignon Blanc", "14.0", "A refreshing white wine with bright acidity and hints of tropical fruit.", "2020", "18"});
        wines.put(6, new String[]{"Zinfandel", "16.0", "A robust red wine with jammy fruit flavors and a spicy finish.", "2015", "22"});
        wines.put(7, new String[]{"Riesling", "17.0", "A sweet white wine with floral aromas and flavors of peach and apricot.", "2014", "28"});
        wines.put(8, new String[]{"Syrah", "22.0", "A full-bodied red wine with dark fruit flavors and peppery notes.", "2013", "12"});
        wines.put(9, new String[]{"Malbec", "19.0", "A bold red wine with flavors of blackberry, plum, and hints of cocoa.", "2012", "16"});
        wines.put(10, new String[]{"Rosé", "13.0", "A light and fruity pink wine with flavors of strawberry and watermelon.", "2021", "20"});
    }
    ...
    public void addLowStockItems() {
        ...
        //MGMNTImpl mgmnt = MGMNTImpl.getInstance();
        //lowStockItems = mgmnt.getLowStockOrders();
    }
